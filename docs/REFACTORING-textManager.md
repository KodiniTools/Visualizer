...
> Status: **Vorschlag** (keine Code-Änderung). Nachfolge-Dokument zu
...
| 7 | *(optional, eigener PR)* `computeAudioReactiveValues` um `levelOptions` erweitern und `getAudioReactiveValues` darauf umstellen | mittel | −45 |
