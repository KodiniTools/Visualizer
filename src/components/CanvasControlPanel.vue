      ...
      <div class="panel-section">
        ...
        <template v-if="beatDropStore.enabled">
          ...
          <template v-if="beatDropStore.vignettePulseEnabled">
            <div class="control-group compact">
              <label
                >{{ t('beatDrop.intensity') }}: {{ beatDropStore.vignettePulseIntensity }}%</label
              >
              <input
                type="range"
...
/* Section headers: gold/purple text → navy */
...
/* Selects: dark bg → light, purple focus → navy */
