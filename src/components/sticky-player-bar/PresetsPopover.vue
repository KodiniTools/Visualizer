<template>
  <div v-popover-drag="initOffset" class="spb-popover spb-popover-presets">
    <div class="spb-popover-header">
      <span class="section-label">{{ t('player.openPresets') }}</span>
    ...
    <div class="spb-presets-scroll">
      <PresetPanel embedded />
    </div>
  </div>
</template>
...
const close = () => closePopover('presets')
const initOffset = cascadeOffset('presets')
</script>
...
.spb-popover-presets .spb-popover-header {
  padding: 12px 12px 0;
}
.spb-presets-scroll {
