export default {
  ...
  player: {
    ...
    color: 'Farbe',
    change: 'Ändern',
    visualizerVisible: 'Visualizer anzeigen',
    visualizerVisibleHint:
      'Jeder Marker erzwingt den Visualizer-Zustand: aktiviert = anzeigen, deaktiviert = nur Hintergrund (inkl. Audio-Reaktiv)',
    visualizerHidden: 'Visualizer ausgeblendet',
    background: 'Hintergrund',
    myLayerPresets: 'Eigene Presets',
    ...
    transitionHint: 'Weiche Überblendung (Crossfade) beim Marker-Wechsel während der Wiedergabe',
    label: 'Label',
    time: 'Zeit',
    volume: 'Lautstärke',
    bass: 'Bass',
  ...
  recorder: {
    ...
    recordingFps: 'Aufnahme-Bildrate',
    recordingFps30Info: '30 fps – empfohlener Standard, läuft auf jeder Hardware',
    recordingFps60Info: '60 fps – flüssigere Bewegung, benötigt moderne Hardware',
    ...
    addMicrophone: 'Mikrofon zuschalten',
    activatingMicrophone: 'Aktiviere Mikrofon...',
    micOnlyHint: '💡 Nur Mic? Player pausieren oder stumm schalten',
    conversionPreviewDesc: 'Schnell, niedrige Qualität',
    conversionMediumDesc: 'Gute Balance',
    conversionSocialDesc: 'Optimiert für Social Media',
    conversionHighDesc: 'Hohe Qualität',
    conversionHighestDesc: 'Maximale Qualität',
  },
  ...
  visualizer: {
    ...
    savePresetHint:
      'Speichert die aktuellen Layer als eigenes Preset (Visualizer-Liste + Beat-Marker)',
    presetNamePlaceholder: 'Name des Presets',
    noLayerPresets: 'Noch keine Presets gespeichert',
    applyPreset: 'Preset anwenden',
    deletePreset: 'Preset löschen',
    confirmDeletePreset: 'Preset wirklich löschen?',
    layerPresetSaved: 'Layer-Preset gespeichert',
    layerPresetNoLayers: 'Keine Layer vorhanden – zuerst Layer hinzufügen',
  ...
  canvasControl: {
    ...
    gradientEffects: 'Gradient-Effekte',
    undo: 'Rückgängig',
    inHistory: 'im Verlauf',
    presets: 'Canvas-Presets',
    saveAsPreset: 'Canvas als Preset speichern',
    savedPresets: 'Gespeicherte Presets',
    presetSaved: 'Canvas-Preset gespeichert',
    presetSaveFailed: 'Preset konnte nicht gespeichert werden (Speicher voll)',
  ...
  ticker: {
    ...
    positionXHint: '0 % = links, 100 % = rechts',
    center: 'Zentrieren',
    centerHint: 'Text mittig auf dem Canvas ausrichten (50 %)',
    ...
    audioReactive: 'Audio-reaktiv (zum Beat)',
    reactMode: 'Animation',
    reactModeTempo: 'Tempo (Geschwindigkeit)',
    reactModeScale: 'Größe (Puls)',
    ...
    shadowBlur: 'Schattendicke',
    sectionText: 'Text & Schrift',
    sectionOutline: 'Umrandung & Schatten',
  ...
  textManager: {
    ...
    resetDefaultToast: 'Standard-Einstellungen zurückgesetzt',
    ...
    permanentDisplay: 'Permanent anzeigen',
    permanentDisplayHint: 'Text bleibt dauerhaft sichtbar',
    displayDuration: 'Anzeigedauer',
    displayDurationHint: 'Wie lange der Text sichtbar bleibt, bevor er verschwindet',
    ...
    addToCanvasPlain: 'Ohne Effekt zum Canvas hinzufügen',
    addToCanvasPlainTitle: 'Text einfach und ohne Animation zum Canvas hinzufügen',
    addToCanvasTypewriter: 'Mit Schreibmaschinen-Effekt hinzufügen',
    addToCanvasFade: 'Mit Fade-Effekt hinzufügen',
    addToCanvasScale: 'Mit Skalierungs-Effekt hinzufügen',
    addToCanvasSlide: 'Mit Slide-Effekt hinzufügen',
    ...
    textSpecific: 'Text-spezifische Einstellungen',
    reactionPresets: 'Reaktions-Presets',
    textEffects: 'Text-Effekte',
    ...
    beatPulse: 'Beat-Puls',
    beatPulseHint:
      'Rhythmischer Puls: schlägt auf jedem erkannten Beat an und klingt aus (Scale + Glow)',
  ...
  foto: {
    ...
    rhythmEffects: 'Rhythmus-Effekte',
  ...
  slideshow: {
    ...
    audioModeOff: 'Aus',
    audioModeSaved: 'Gespeicherte Einstellungen',
    presets: 'Slideshow-Presets',
    ...
    presetHint:
      'Gespeichert werden Timing, Optionen (inkl. Maus-Modus), Position/Größe sowie pro Bild-Position Anzeigedauer, Audio-Reaktion, Bild-Anpassungen und eigene Größe/Position. Stock-Bilder werden dauerhaft mitgespeichert, hochgeladene Bilder nur für die aktuelle Sitzung. Laden wirkt auch während der Slideshow.',
    ...
    presetStockHint: 'Enthält Stock-Bilder (dauerhaft gespeichert)',
