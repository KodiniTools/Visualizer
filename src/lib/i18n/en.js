export default {
  ...
  player: {
    ...
    transitionHint: 'Smooth crossfade when switching markers during playback',
    label: 'Label',
    time: 'Time',
    volume: 'Volume',
    bass: 'Bass',
    ...
    timeFormatHint: '(M:SS.hh or sec.)',
    timeStepBack: 'Time back (step size)',
    timeStepForward: 'Time forward (step size)',
    timeStepSlow: 'slow (0.01 s)',
    timeStepMedium: 'medium (0.1 s)',
    timeStepFast: 'fast (1 s)',
  ...
  recorder: {
    ...
    recordingFps30Info: '30 fps – recommended default, works on all hardware',
    recordingFps60Info: '60 fps – smoother motion, needs modern hardware',
  ...
  visualizer: {
    ...
    savePresetHint: 'Saves the current layers as your own preset (visualizer list + beat markers)',
    presetNamePlaceholder: 'Preset name',
    noLayerPresets: 'No presets saved yet',
    applyPreset: 'Apply preset',
    deletePreset: 'Delete preset',
    confirmDeletePreset: 'Really delete this preset?',
    layerPresetSaved: 'Layer preset saved',
    layerPresetNoLayers: 'No layers available – add a layer first',
    ...
    reactSource: {
      ...
      treble: 'Treble',
      volume: 'Volume',
      onsetGroup: 'Onset (beat, auto-normalised)',
      bassOnset: 'Bass onset',
      midOnset: 'Mid onset',
      trebleOnset: 'Treble onset',
      allOnset: 'All onset',
  ...
  canvasControl: {
    ...
    onsetGroup: 'Onset (beat, auto-normalized)',
    bassOnset: 'Bass Onset',
    midOnset: 'Mid Onset',
    trebleOnset: 'Treble Onset',
    allOnset: 'All Onset',
    ...
    saveAsPreset: 'Save canvas as preset',
    savedPresets: 'Saved Presets',
    presetSaved: 'Canvas preset saved',
    presetSaveFailed: 'Preset could not be saved (storage full)',
  ...
  ticker: {
    ...
    down: 'Downwards',
    speed: 'Scroll Speed',
    audioReactive: 'Audio-reactive (to the beat)',
    reactMode: 'Animation',
    reactModeTempo: 'Tempo (speed)',
    reactModeScale: 'Size (pulse)',
    reactModeGlow: 'Glow',
    ...
    shadowBlur: 'Shadow Thickness',
    sectionText: 'Text & Font',
    sectionOutline: 'Outline & Shadow',
  ...
  textManager: {
    ...
    resetDefaultToast: 'Default settings reset',
    addText: 'Add Text',
    ...
    permanentDisplay: 'Display permanently',
    permanentDisplayHint: 'Text stays visible permanently',
    displayDuration: 'Display Duration',
    displayDurationHint: 'How long the text stays visible before disappearing',
    ...
    addToCanvasSlide: 'Add with slide effect',
    autoWrap: 'Auto-wrap',
    ...
    textSpecific: 'Text-specific settings',
    reactionPresets: 'Reaction presets',
  ...
  foto: {
    ...
    selected: 'selected',
    multiselectHint: 'Tip: checkbox or Ctrl+click for multi-select, Shift+click for range',
    slideshowSelectHint: 'Select at least 2 images for the slideshow – just click the checkboxes.',
  ...
  slideshow: {
    ...
    perImageHint:
      'Per image: audio reaction and display duration (s). Empty/Default = global setting.',
    ...
    presetHint:
      'Saves timing, options (incl. mouse mode), position/size and, per image position, display duration, audio reaction, image adjustments and own size/position. Stock images are saved permanently, uploaded images for the current session only. Loading also works while the slideshow runs.',
    ...
    presetStockHint: 'Contains stock images (saved permanently)',
