export default {
  ...
  player: {
    ...
    openVideo: 'Video',
    openSlideshow: 'Image slideshow',
    slideshowEmpty: 'Select at least 2 images from the gallery to create a slideshow.',
  ...
  foto: {
    ...
    size: 'Size',
    positionSize: 'Position & size',
    positionX: 'Position X (center)',
    positionY: 'Position Y (center)',
    imageWidth: 'Width',
    imageHeight: 'Height',
