...
const defaultColorOptions = [
  {
    ...
    name: 'Blau',
    color: '#6ea8fe',
    gradient: 'linear-gradient(135deg, #6ea8fe 0%, #5a96e5 100%)',
  },
  {
    id: 'purple',
    name: 'Lila',
    color: '#9c7cf4',
    gradient: 'linear-gradient(135deg, #9c7cf4 0%, #7c5ce0 100%)',
  },
  {
    id: 'green',
    name: 'Grün',
...
export const usePanelSettingsStore = defineStore('panelSettings', () => {
  ...
  function getSelectedColor() {
    ...
    return (
      colorOptions.value.find((c) => c.id === selectedImageSectionColorId.value) ||
  ...
  function applyColorToCSS() {
    ...
    document.documentElement.style.setProperty(
      '--image-section-accent-rgb',
      hexToRgb(selectedColor.color),
    )
  }
